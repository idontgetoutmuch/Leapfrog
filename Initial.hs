...
jupiterV :: (Double, Double, Double)
jupiterV = (-1.0965244901087316e02, -1.3710001990210707e04 0)

jupiterQ :: (Double, Double, Double)
jupiterQ = (negate jupiterPerihelion, 0, 0)

earthV :: (Double, Double, Double)
earthV = (2.694354528161541e03, 3.016946927465788e04, 0)

earthQ :: (Double, Double, Double)
earthQ = (earthPerihelion, 0, 0)
